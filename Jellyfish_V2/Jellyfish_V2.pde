...
void draw() {
  ...
  //specular(255, 0, 255);
 // shader(sh);
  //sh.set("lightPosition", 100.0, -150.0, 200.0);
  jellyfish();
...
//resetShader();
//ambientLight(30, 0, 80);
//pointLight(180, 160, 255, width / 2 + 200, height / 2 - 300, 500);
//shader(sh);
//sh.set("useLighting", 1.0);
//    for(int i = 0; i < totalPhi; i++) {
//      float phi0 = map(i, 0, totalPhi, 0, HALF_PI);
//      float phi1 = map(i + 1, 0, totalPhi, 0, HALF_PI);
...
//        float x0 = radius * bellScale * sin(phi0) * cos(theta);
//        float y0 = -radius * cos(phi0);
//        float z0 = radius * bellScale * sin(phi0) * sin(theta);
        
//        float nx0 = sin(phi0) * cos(theta);
//        float ny0 = -cos(phi0);
//        float nz0 = sin(phi0) * sin(theta);
  
//        float x1 = radius * bellScale * sin(phi1) * cos(theta);
//        float y1 = -radius * cos(phi1);
//        float z1 = radius * bellScale * sin(phi1) * sin(theta);
...
//        float ratioTop = (float) i / totalPhi;
//        float ratioBot = (float) (i+1) / totalPhi;
//        float alphaTop = 20 * pow(1.0 - ratioTop * 0.9, 2);
//        float alphaBot = 20 * pow(1.0 - ratioBot * 0.9, 2);
