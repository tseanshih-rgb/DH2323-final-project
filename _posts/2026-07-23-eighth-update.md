...
Clause provided four approaches:
  ...
  - Make heading account for the current too, not just swim velocity (RECOMMEND):
  ...
  - Give seekMouse a distance falloff and a perception radius (same design as flee) (RECOMMEND):
